...
namespace Net14Web.Models.ValidationAttributes.ManagmentCompany
{
    public class CheckPasswordRegViewAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            if (validationContext.ObjectInstance is not Models.ManagmentCompany.RegistrationViewModel)
            {
