...
namespace Net14Web.Migrations
{
    ...
    [Migration("20240512213537_ClientBookingPromoCodeOneToOne")]
    partial class ClientBookingPromoCodeOneToOne
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FavouritePlaceUser", b =>
                {
                    b.Property<int>("FavouritePlacesId")
                        .HasColumnType("int");

                    b.Property<int>("UsersId")
                        .HasColumnType("int");

                    b.HasKey("FavouritePlacesId", "UsersId");

                    b.HasIndex("UsersId");

                    b.ToTable("FavouritePlaceUser");
                });
            ...
            modelBuilder.Entity("Net14Web.DbStuff.Models.BookingWeb.FavouritePlace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Net14Web.DbStuff.Models.BookingWeb.PromoCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("UniquePromoCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FavouritePlaceUser", b =>
                {
                    b.HasOne("Net14Web.DbStuff.Models.BookingWeb.FavouritePlace", null)
                        .WithMany()
                        .HasForeignKey("FavouritePlacesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Net14Web.DbStuff.Models.BookingWeb.PromoCode", b =>
                {
                    b.HasOne("Net14Web.DbStuff.Models.BookingWeb.ClientBooking", "ClientBooking")
                        .WithOne("PromoCode")
                        .HasForeignKey("Net14Web.DbStuff.Models.BookingWeb.PromoCode", "ClientBookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
